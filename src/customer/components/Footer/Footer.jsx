        ...
        <div>
            <Grid className='bg-black text-white text-center mt-10'
                ...
                <Grid item xs={12} sm={6} md={3}>
                    ...
                    <div> <Button className='pb-5' variant='h6' gutterBottom> <p>About</p> </Button></div>
                ...
                <Grid item xs={12} sm={6} md={3}>
                    ...
                    <div> <Button className='pb-5' variant='h6' gutterBottom> Alaytics </Button></div>
                ...
                <Grid item xs={12} sm={6} md={3}>
                    ...
                    <div> <Button className='pb-5' variant='h6' gutterBottom> Terms & Conditions </Button></div>
                </Grid>
                <Grid className='pt-20' item xs={12}>
                    <Typography variant='body2'component="p" align='center'>
                        &copy; 2024 shoppingMate.com<br></br>
                         All rights reserved. Made by Aditya Sonawale
                    </Typography>
                    <Typography variant='body2'component="p" align='center'>
