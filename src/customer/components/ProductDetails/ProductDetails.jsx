    ...
    <div className="bg-white lg:px-20">
      <div className="pt-6">
            ...
            <div className="mt-4 lg:row-span-3 lg:mt-0">
              ...
              <div className="mt-6">
                <div className="flex items-center space-x-3">
                  ...
                  <p className="opacity-50 text-sm">56,540 Ratings</p>
                  <p className="ml-3 text-sm font-normal text-indigo-600 hover:text-indigo-500">
                    5,760 Reviews
                  </p>
                </div>
              </div>
        ...
        <section className="pt-10 ">
          <h1 className="py-5 text-xl font-bold px-5">Similar Products</h1>
          <div className="flex flex-wrap mb-2 space-y-5 px-12 py-10 ">
            {mens_kurta.map((item) => (
